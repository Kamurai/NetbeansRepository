    ...
    public String getNavigation(int vLevel){
        ...
        vResult += "<ul class=\"navigationUl\">";
            ...
            vResult += "<li><a class=\"navlinkA\" href=\"../Section1/Index.jsp\">Antarrea</a></li>";
                vResult += "<li><a class=\"navlinkB\" href=\"./Project1.jsp\">Revolutions: Invading Nations</a></li>";
                vResult += "<li><a class=\"navlinkB\" href=\"./Project2.jsp\">Revolutions: Rebellion Against the Fist</a></li>";
                vResult += "<li><a class=\"navlinkB\" href=\"./Project3.jsp\">Revolutions: Return to Arms</a></li>";
                vResult += "<li><a class=\"navlinkB\" href=\"./Project4.jsp\">Revolutions: Post Wars</a></li>";
                vResult += "<li><a class=\"navlinkB\" href=\"./Project5.jsp\">Avia: Elemental Angel</a></li>";

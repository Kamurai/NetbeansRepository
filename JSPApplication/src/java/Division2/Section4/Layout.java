...
public class Layout extends Main.Layout
{
    ...
    {
        String vResult = "";
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section1/Section2/Section4/Index.jsp'>Gynowars</a><br/><br/>";
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Section2/Section4/Index.jsp'>Renley</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Project1.html'>Warring Nations</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Project2.html'>Psychodom: The One Empire</a><br/><br/>";
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section2/Section4/Index.jsp'>Antarrea</a><br/><br/>";

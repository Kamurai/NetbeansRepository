...
public class Layout extends Main.Layout
{
    ...
    public String getNavigation(int vLevel){
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.getPath(vLevel)+"Division2/Section4/Index.jsp'>Gynowars</a><br/><br/>";
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.getPath(vLevel)+"Division2/Section4/Index.jsp'>Renley</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division2/Section4/Project1.jsp'>Warring Nations</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division2/Section4/Project2.jsp'>Psychodom: The One Empire</a><br/><br/>";

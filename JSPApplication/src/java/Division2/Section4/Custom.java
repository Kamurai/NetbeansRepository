...
public class Custom extends Division2.Custom
{
    ...
    public String Versions(int vPage)
    {
        ...
        else if(vPage == 1)
        {
            ...
            vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section4/Project1\">JSF</a><br/>";
        ...
        else if(vPage == 2)
        {
            ...
            vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section4/Project2\">JSF</a><br/>";

    ...
    public String getNavigation(int vLevel){
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Index.jsp'>Antarrea</a><br/><br/>";
            ...
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Section2/Index.jsp'>Grendol</a><br/><br/>";
                vResult += "<a class=\"navlinkC\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Section2/Project1.jsp'>Land of the Orcish Empire: Age of Magic</a><br/><br/>";
                vResult += "<a class=\"navlinkC\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Section2/Project2.jsp'>Coliseum: Arena</a><br/><br/>";

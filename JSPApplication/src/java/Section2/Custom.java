...
public class Custom extends Main.Custom
{
    ...
    public String Versions(int vPage)
    {
        ...
        else if(vPage == 1)
        {
            ...
            Result += "<a href=\"http://htkb.dyndns.org:81/ASP/Section2/Project1.asp\">ASP VBscript</a><br/>";
        ...
        else if(vPage == 4)
        {
            ...
            Result += "<a href=\"http://htkb.dyndns.org:81/ASP/Section2/Project4.asp\">ASP VBscript</a><br/>";
        ...
        else if(vPage == 5)
        {
            ...
            Result += "<a href=\"http://htkb.dyndns.org:81/ASP/Section2/Project5.asp\">ASP VBscript</a><br/>";

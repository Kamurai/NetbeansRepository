        ...
        if(input == 0)
         {
            ...
            Result += "<a href=\"http://htkb.dyndns.org:84/Section2/Section6/Section2/index\">Node JS</a><br/>";
         ...
         else if(input == 1)
         {
            ...
            Result += "<a href=\"http://htkb.dyndns.org:84/Section2/Section6/Section2/Project1\">Node JS</a><br/>";

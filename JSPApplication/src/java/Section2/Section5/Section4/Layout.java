...
import Section2.Section5.Section3.*;
import Section2.Section5.Section2.*;
import Section2.Section5.Section1.*;
import Section2.Section5.*;
import Section2.Section4.*;
    ...
    public String Navigation(int vLevel)
    {
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Index.jsp'>Antarrea</a><br/><br/>";
            ...
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section4/Index.jsp'>Elvia</a><br/><br/>";
                vResult += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section4/Project1.jsp'>Nine Card</a><br/><br/>";

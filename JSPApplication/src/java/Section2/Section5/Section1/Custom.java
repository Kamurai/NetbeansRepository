    ...
    public String Navigation(int level, int extension)
    {
        ...
        Result += "<a class=\"navlinkA\" href='"+bob.GetPath(level)+"Section2/Section5/Index.jsp'>Antarrea</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Index.jsp'>Global</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Project1.jsp'>Team Tactial: Crash Ball</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Project2.jsp'>Wars of Antarrea</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Project3.jsp'>Revolutions: Invading Nations</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Project4.jsp'>Revolutions: Rebellion Against the Fist</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Project5.jsp'>Revolutions: Return to Arms</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+bob.GetPath(level)+"Section2/Section5/Section1/Project6.jsp'>Revolutions: Post Wars</a><br/><br/>";

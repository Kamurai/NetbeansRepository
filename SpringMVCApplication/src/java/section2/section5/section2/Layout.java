    ...
    public String Navigation(int level, int extension)
    {
        ...
        Result += "<a class=\"navlinkA\" href='"+universal.GetPath(level)+"Section2/Section5/Index'>Antarrea</a><br/><br/>";
            ...
            Result += "<a class=\"navlinkB\" href='"+universal.GetPath(level)+"Section2/Section5/Section2/Index'>Grendol</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+universal.GetPath(level)+"Section2/Section5/Section2/Project1'>Land of the Orcish Empire: Age of Magic</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+universal.GetPath(level)+"Section2/Section5/Section2/Project2'>Coliseum: Arena</a><br/><br/>";

...
public class Custom extends Main.Custom{
    ...
    public String getContent(int vPage){
        ...
        if(vPage <= 0){
            ...
            Result += "./Content/Content_Project16.xhtml";
        }else if(vPage == 14){
            Result += "./Content/Content_Project17.xhtml";
        }else{
            Result += "./Content/Content_Index.xhtml";
        }
    ...
    public String getVersions(int vPage){
        ...
        if(vPage <= 0){
            ...
            Result += "./Content/Versions_Project16.xhtml";
        }else if(vPage == 17){
            Result += "./Content/Versions_Project17.xhtml";
        }else{
            Result += "./Content/Content_Index.xhtml";
        }
